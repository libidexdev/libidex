...
CREATE TABLE IF NOT EXISTS {$this->getTable('dropship')} (
  ...
  `ismetapak` tinyint(1) NOT NULL default '0' COMMENT 'webshopapps dropship',
   ...
   `usps_user_id` varchar(255) NULL COMMENT 'webshopapps dropship',
    ...
    `fedexfreight_account_id` varchar(30) DEFAULT NULL COMMENT 'webshopapps dropship',
    `fedexfreight_key` varchar(255) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_password` varchar(255) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_meter_number` varchar(255) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_street` varchar(60) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_city` varchar(30) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_zipcode` varchar(30) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_state` varchar(255) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_country` varchar(255) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_freight_role` varchar(30) NULL COMMENT 'webshopapps dropship',
    `fedexfreight_payment_type` varchar(30) NULL COMMENT 'webshopapps dropship',
