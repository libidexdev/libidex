...
if (Mage::helper('wsalogger')->getNewVersion() > 10) {
    ...
    $quoteAddressTable = $installer->getTable('sales_flat_quote_address');
    $quoteRateTable = $installer->getTable('sales_flat_quote_shipping_rate');
...
if (Mage::helper('wsalogger')->getNewVersion() >= 8) {
    if (Mage::helper('wsalogger')->getNewVersion() > 10) {
        ...
        $shipmentTable = $installer->getTable('sales_flat_shipment');
