<?php
class ObjectSource_OrderFulfillment_Block_Adminhtml_Widget_Grid_Column_Renderer_Store extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Store
{
    public function render(Varien_Object $row)
    {
        ...
        if (get_class($row) == 'ObjectSource_OrderFulfillment_Model_Sales_Order')
            return Mage::getModel('core/store')->load($row->getStoreId())->getName();
